...
//        vkpointfeatureMap/*@START_MENU_TOKEN@*/.swipeRight()/*[[".swipeUp()",".swipeRight()"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
//        app.navigationBars["Draw area with finger"].buttons["compose"].tap()
//        vkpointfeatureMap.swipeRight()
